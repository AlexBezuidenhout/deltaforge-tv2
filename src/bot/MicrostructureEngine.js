class MicrostructureEngine {
   ...
   */
  composite(data) {
    // Default every book field to 0 — synthetic order books may omit them, and
    // undefined here silently zeroes the imbalance/whale terms (or NaNs depth).
    const {
      btcPrice, polyPrice,
      bidSize = 0, askSize = 0,
      largestBid = 0, largestAsk = 0,
      totalDepth = 0, avgOrderSize = 0
    } = data;
