...
const SPORTS_PHYSICAL_V2_EXPERIMENT_ID = 'structural-sports-physical-implications-v2';
const SPORTS_PHYSICAL_V2_UNIVERSE_ID = 'sports-physical-payoff-graph-v2';
const STRUCTURAL_VISIBLE_UNIVERSE_IDS = Object.freeze([
  STRUCTURAL_BASE_EXPERIMENT_ID,
  SPORTS_PHYSICAL_UNIVERSE_ID,
  SPORTS_PHYSICAL_V2_UNIVERSE_ID,
]);
...
function structuralExperimentId(structureType) {
  ...
  if (String(structureType).startsWith('sports_exact_score_')) {
    return SPORTS_PHYSICAL_V2_EXPERIMENT_ID;
  }
...
module.exports = {
  ...
  SPORTS_PHYSICAL_V2_EXPERIMENT_ID,
  SPORTS_PHYSICAL_UNIVERSE_ID,
  SPORTS_PHYSICAL_V2_UNIVERSE_ID,
  STRUCTURAL_BASE_EXPERIMENT_ID,
