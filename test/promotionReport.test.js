...
test('promotion summary clusters by market and UTC day and splits independent markets', () => {
  const rows = [
    { market_id: 1, available_at: '2026-07-18T00:00:00Z', pnl_1x: 100, pnl_2x: 1, data_quality_grade: 'A', asset: 'btc' },
    { market_id: 1, available_at: '2026-07-18T00:00:01Z', pnl_1x: 100, pnl_2x: 2, data_quality_grade: 'A', asset: 'btc' },
    { market_id: 2, available_at: '2026-07-19T00:00:00Z', pnl_1x: 100, pnl_2x: 3, data_quality_grade: 'B', asset: 'eth' },
    { market_id: 2, available_at: '2026-07-19T00:00:01Z', pnl_1x: 100, pnl_2x: 4, data_quality_grade: 'B', asset: 'eth' },
  ];
